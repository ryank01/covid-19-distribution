...
<head>
	...
	<title>react-svg-tooltip | react-svg-tooltip</title>
...
<div class="container container-main">
	<div class="content-wrap">
		<div class="tsd-panel tsd-typography">
			<h1 id="react-svg-tooltip-build-status-github-license-npm-version">React SVG Tooltip <a href="https://travis-ci.org/netzwerg/react-svg-tooltip"><img src="https://travis-ci.org/fhnw-stec/stec-recorder.svg?branch=master" alt="Build Status"></a> <a href="https://github.com/facebook/react/blob/master/LICENSE"><img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="GitHub license"></a> <a href="https://www.npmjs.com/package/react-svg-tooltip"><img src="https://img.shields.io/npm/v/react-svg-tooltip.svg?style=flat" alt="npm version"></a></h1>
			<p>A React component to create tooltips for SVG elements.</p>
			<p>The library offers a <code>Tooltip</code> component which can be embedded into any SVG element hierarchy.
			...
			Behind the scenes, the library handles all mouse listener logic and makes sure that your tooltip is always rendered on top of all other SVG elements (by using a <a href="https://reactjs.org/docs/portals.html">React portal</a>).</p>
			<p>You might want to read <a href="https://netzwerg.ch/blog/2018/05/24/react-svg-tooltips/">this blog post</a> for further details.</p>
			<h2 id="installation">Installation</h2>
			<p><code>npm install react-svg-tooltip</code></p>
			<p>Note that <code>react</code> and <code>react-dom</code> peer dependencies must already be installed in version <code>16.3.x</code> or above.</p>
			<h2 id="basic-usage">Basic Usage</h2>
			<p>This example demonstrates how to attach a rectangular tooltip with some text to a circle shape.
				The <code>triggerRef</code> property accepts a reference to an arbitrary element (a circle in our example), which further serves as the mouse trigger.
			Note how the x/y-coordinates of the tooltip contents (<code>rect</code> and <code>text</code>) can be expressed relative to the mouse position. </p>
			<pre><code class="language-jsx"><span class="hljs-keyword">import</span> * <span class="hljs-keyword">as</span> React <span class="hljs-keyword">from</span> <span class="hljs-string">'react'</span>;
<span class="hljs-keyword">import</span> { Tooltip } <span class="hljs-keyword">from</span> <span class="hljs-string">'react-svg-tooltip'</span>;

<span class="hljs-keyword">const</span> App = <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> {

    <span class="hljs-keyword">const</span> circleRef = React.createRef&lt;SVGCircleElement&gt;();
...
export default App;</code></pre>
			<p><a href="https://codesandbox.io/s/4wjoopo1vx"><img src="https://codesandbox.io/static/img/play-codesandbox.svg" alt="Edit 4wjoopo1vx"></a></p>
			<p><img src="screenshot-basic.png" alt="Basic Usage"></p>
			<h2 id="advanced-usage">Advanced Usage</h2>
			<p>By default, the tooltip is added to the SVG root element which parents the triggering element.
				This can be limiting in certain scenarios, e.g. if a small SVG triggers a tooltip which is larger than its own SVG root.
				It is therefore possible to add the tooltip to a <em>different</em> SVG root, making glass-pane-like usages possible.
				The following example illustrates how 3 small SVG tiles can display tooltips on a shared SVG glass pane.
			The wiring is achieved through the <code>containerRef</code> property.</p>
			<pre><code class="language-jsx"><span class="hljs-keyword">import</span> * <span class="hljs-keyword">as</span> React <span class="hljs-keyword">from</span> <span class="hljs-string">"react"</span>;
...
<span class="hljs-keyword">const</span> App = <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> {
  <span class="hljs-keyword">const</span> containerRef = React.createRef&lt;SVGSVGElement&gt;();

  <span class="hljs-keyword">const</span> triggerRef1 = React.createRef&lt;SVGSVGElement&gt;();
  <span class="hljs-keyword">const</span> triggerRef2 = React.createRef&lt;SVGSVGElement&gt;();
  <span class="hljs-keyword">const</span> triggerRef3 = React.createRef&lt;SVGSVGElement&gt;();
...
ReactDOM.render(&lt;App /&gt;, document.getElementById("root"));</code></pre>
			<p><a href="https://codesandbox.io/s/w6vqpkv36l"><img src="https://codesandbox.io/static/img/play-codesandbox.svg" alt="Edit w6vqpkv36l"></a></p>
			<p><img src="screenshot-advanced.png" alt="Advanced Usage"></p>
			<h2 id="acknowledgements">Acknowledgements</h2>
			<p>Based on <a href="https://github.com/tonysneed/typescript-library-starter-lite.git">typescript-library-starter-lite</a>.</p>
			<h2 id="license">License</h2>
			<p>Licensed under <a href="LICENSE">MIT License</a>.</p>
			<p>&copy; Rahel Lüthy 2018</p>
		</div>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-external-module"><a href="modules/_tooltip_.html" class="tsd-kind-icon">"<wbr>Tooltip"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_react_svg_tooltip_.html" class="tsd-kind-icon">"react-<wbr>svg-<wbr>tooltip"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_svg_point_.html" class="tsd-kind-icon">"svg-<wbr>point"</a></li>
						</ul>
					</section>
				</div>
			</section>
