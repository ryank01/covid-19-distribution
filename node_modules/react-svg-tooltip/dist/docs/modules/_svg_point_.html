...
<head>
	...
	<title>&quot;svg-point&quot; | react-svg-tooltip</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-function tsd-parent-kind-external-module">
			<a href="_svg_point_.html#svgpoint" class="tsd-kind-icon">svg<wbr>Point</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-function tsd-parent-kind-external-module"><a href="_svg_point_.html#svgpoint" class="tsd-kind-icon">svg<wbr>Point</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-external-module">
				<a name="svgpoint" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagConst">Const</span> svg<wbr>Point</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-external-module">
					<li class="tsd-signature tsd-kind-icon">svg<wbr>Point<span class="tsd-signature-symbol">(</span>svg<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">SVGSVGElement</span>, event<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">MouseEvent</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">[]</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/netzwerg/react-svg-tooltip/blob/c2a5e08/src/svg-point.ts#L8">svg-point.ts:8</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Returns the <em>x* and *y</em> coordinates of the mouse relative to the svg root container element.
									The coordinates are returned as an array of two-elements [<em>x*, *y</em>].
								Inspired by <a href="https://raw.githubusercontent.com/d3/d3-selection/master/src/point.js">https://raw.githubusercontent.com/d3/d3-selection/master/src/point.js</a></p>
							</div>
						</div>
						...
						<ul class="tsd-parameters">
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<div class="lead">
										<p>the root svg container element</p>
									</div>
								</div>
							</li>
							<li>
